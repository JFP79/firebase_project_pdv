...
Instale as dependências no diretório do projeto:
 cd pdv-node
 npm install
Configurações do Firebase: 3.1 Crie um projeto no Firebase. 3.2 Configure o Firestore e obtenha as credenciais de acesso. 3.3 Crie um arquivo .env na raiz do projeto com a seguinte configuração:
